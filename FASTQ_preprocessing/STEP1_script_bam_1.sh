...
~/miniconda3/envs/NGS/bin/bwa mem -t4 ../Ref/solap_A12.fa ../Data/BM_VDJ_S2_L001_R2_001.fastq > ./solap_A12_reg_L001.sam
...
}' solap_A12_reg_L001.sam > solap_A12_reg_L001_filtered.sam
